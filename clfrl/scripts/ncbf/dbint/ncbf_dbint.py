...
import run_config.ncbf.doubleintwall_cfg
import wandb
...
def main(name: str = typer.Option(..., help="Name of the run."), group: str = typer.Option(None), seed: int = 7957821):
    ...
    run_dir = init_wandb_and_get_run_dir(CFG, "clfrl", "ncbf_doubleintwall", name, group=group)
