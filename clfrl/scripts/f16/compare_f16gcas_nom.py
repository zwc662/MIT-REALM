...
from clfrl.ncbf.compute_disc_avoid import AllDiscAvoidTerms
from clfrl.plotting.legend_helpers import lline
from clfrl.plotting.plotstyle import PlotStyle
from clfrl.utils.ckpt_utils import get_id_from_ckpt, get_run_path_from_ckpt
from clfrl.utils.easy_npz import EasyNpz
from clfrl.utils.jax_utils import jax_default_x32
...
def gen(ckpt1: pathlib.Path, ckpt2: pathlib.Path):
    ...
    gen_nom(ckpt1, plot=False)
    gen_nom(ckpt2, plot=False)
