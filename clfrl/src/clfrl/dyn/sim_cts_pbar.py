...
from clfrl.utils.jax_utils import merge01
...
class SimCtsPbar:
    ...
    def rollout_plot(self, x0: State):
        ...
        t0 = jnp.array(0.0)
        t_final = jnp.array(tf)

        # T_xs = jnp.concatenate([T_xs, x_final[None]], axis=0)
        # T_ts = jnp.concatenate([T_ts, t_final[None]], axis=0)
