...
import clfrl.utils.jax_types
from clfrl.utils.jax_types import Arr, BFloat, BoolScalar, Shape
...
def jax_use_double():
    ...
    clfrl.utils.jax_types.set_current_float(np.float64)
...
def tree_unmerge01(tree: _PyTree, shape01: tuple[int, int]) -> _PyTree:
    return jtu.tree_map(unmerge01, tree)
