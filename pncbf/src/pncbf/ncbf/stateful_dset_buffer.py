...
class StatefulDsetBuffer:
    def __init__(self, seed: int, dset_len_max: int = 8):
        ...
        self._dset: IntAvoid.CollectData | None = None
    ...
    def add_dset(self, dset: IntAvoid.CollectData, get_vterms_fn):
    ...
    def sample_batch(self, n_rng: int, n_zero: int) -> IntAvoid.Batch:
        ...
        batch = IntAvoid.Batch(b_x0, b_u0, b_xT, bh_iseqh, bh_lhs, bh_int_rhs, b_discount_rhs)
