...
if __name__ == '__main__':
    f_path = "matrix/trajectories.txt"
    ...
    parser.add_argument('--config', default='./config/pretrained.json', help='Path to config file')
    ...
    parser.add_argument('--mode', default='train', help='Choose the mode, train or eval')

    args = parser.parse_args()

    if args.generate_config:
        generate_config(Params(), "config/icml_2_2/icml_test.json")
    ...
    if args.mode == 'train':
        ...
        assert NameError('No such mode. train or eval?')
